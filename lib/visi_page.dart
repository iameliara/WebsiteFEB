...
import 'data_visi.dart';

class VisiPage extends StatelessWidget {
  final String programStudi;

  VisiPage(this.programStudi);

  @override
  Widget build(BuildContext context) {
    String visi = getVisi(programStudi)?.visi ?? 'Visi tidak ditemukan';

    return Scaffold(
      appBar: AppBar(
        title: Text('Visi Program Studi $programStudi'),
      ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Visi Program Studi $programStudi',
                    style: TextStyle(
                      fontSize: 18,
  ...
  Visi? getVisi(String programStudi) {
    return VisiData.getData(programStudi);
  }
}
